  ...
  return (
    <>
      <div className="about-us-wrapper bg-secondary">
        ...
        <div className="about-left-side-bg bg-img" style={{backgroundImage: `url(/assets/img/bg-img/32.jpg)`}}></div>
          ...
          <div className="row g-4 justify-content-end">
            ...
            <div className="col-12 col-md-6">
              <div className="about-us-text-content ps-md-4">
                ...
                <p className="mb-0">If you ask our clients what it's like working with 36, they'll
                ...
                <div>
                  <a href="#" className="btn btn-primary mt-1"><span>MORE ABOUT US</span><span>MORE ABOUT US</span></a>
                </div>
              </div>
            </div>
          </div>
