            ...
            <div className="col-12 col-md-7 col-lg-8">
               <div className="d-flex flex-column gap-5">
                  ...
                  <div className="single-blog">
                     ...
                     <Link className="post-title mb-5" to="/blog-details">Graphic Design Agency your Brand Needs</Link>
                     <Link to="/blog-details" className="btn btn-primary"><span>READ MORE</span><span>READ
                           MORE</span></Link>
                  </div>
                  ...
                  <div className="single-blog">
                     ...
                     <Link className="post-title mb-5" to="/blog-details">Providing Brilliant Ideas For your Business</Link>
                     <Link to="/blog-details" className="btn btn-primary"><span>READ MORE</span><span>READ
                           MORE</span></Link>
                  </div>
                  ...
                  <div className="single-blog">
                     ...
                     <Link className="post-title mb-5" to="/blog-details">The Latest Trends With Digital Marketing</Link>
                     <Link to="/blog-details" className="btn btn-primary"><span>READ MORE</span><span>READ
                           MORE</span></Link>
                  </div>
                     ...
                     <div className="d-flex flex-column gap-4">
                        ...
                        <div className="widget-blog-post">
                           ...
                           <div className="blog-content">
                              <h6><Link to="/blog-details">Graphic Design Agency your Brand Needs.</Link></h6>
                        ...
                        <div className="widget-blog-post">
                           ...
                           <div className="blog-content">
                              <h6><Link to="/blog-details">Providing Brilliant Ideas For your Business</Link></h6>
                              <p className="mb-0">March 26, 2024</p>
                           </div>
                        </div>
                        ...
                        <div className="widget-blog-post">
                           ...
                           <div className="blog-content">
                              <h6><Link to="/blog-details">The Latest Trends With Digital Marketing</Link></h6>
                              <p className="mb-0">March 26, 2024</p>
                           </div>
                        </div>
                     </div>
